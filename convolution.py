D = 32      # dimensionality of vectors
subD = 16   # dimensionality of input and output ensembles
N = 50     # size of input and output ensembles per dimension
N_C = 200   # size of convolution ensembles
...
import extract
extract.extract(net, filename='convolution.txt')    
